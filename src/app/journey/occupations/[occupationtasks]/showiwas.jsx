...
// PARAMS WILL BE AN ARRAY OF IWAS FOR EACH JOB, eg [["IWA 1","IWA 2"......],["IWA 3","IWA 4"........]]
async function ShowIwas(props) {

  const [iwalist,setIwalist] =  useState([])
  console.log("final list:", props)
  ...
  useEffect(() => {
    const iwaslist = props.iwas[0]
    const joblist = props.jobarray[0]
    if (iwaslist && iwaslist.res) {
      console.log(iwaslist.res)
      setIwalist(iwaslist.res)
    }

    if (joblist && joblist.res) {
      console.log(joblist.res)
      setOccupations(joblist.res)
    }
  }, [props]);
  ...
  if(iwalist.length >0){
    setTasksData(convertTaskData(iwalist))
  }
